package com.mywork.finance.config;

import lombok.extern.slf4j.Slf4j;
import org.springframework.context.annotation.Bean;

import com.mywork.finance.config.SwaggerConfig;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2).groupName("Project REST Service")
				.apiInfo(new ApiInfoBuilder().title("FinanceServer REST API").description("All the methods of the REST API").build()).select().apis(RequestHandlerSelectors.any())
